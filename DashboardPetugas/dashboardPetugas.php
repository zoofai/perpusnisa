...
<html lang="en">
  ...
  <body style="background-color: #D4BEE4;">
      ...
      <div class="container-fluid p-3">
        ...
        <div class="dropdown">
          <button class="btn btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="../assets/petugass.jpg" alt="adminLogo" width="40px">
          </button>
        <ul style="margin-left: -7rem;" class="dropdown-menu position-absolute mt-2 p-2">
          <li>
            <a class="dropdown-item text-center" href="#">
            <img src="../assets/petugass.jpg" alt="adminLogo" width="30px">
            </a>
          </li>
          <li>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-secondary" role="alert">Selamat datang petugas - <span class="fw-bold text-capitalize"><?php echo $_SESSION['petugas']['nama_petugas']; ?></span> di Dashboard Petugas Perpustakaan</div>
