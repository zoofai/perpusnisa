...
<html lang="en">
  ...
  <body style="background-color: #D69ADE;">
      ...
      <div class="container-fluid p-3">
        ...
        <div class="dropdown">
          <button class="btn btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="../assets/cwk.png" alt="adminLogo" width="40px">
          </button>
        <ul style="margin-left: -7rem;" class="dropdown-menu position-absolute mt-2 p-2">
          <li>
            <a class="dropdown-item text-center" href="#">
            <img src="../assets/cwk.png" alt="adminLogo" width="30px">
            </a>
          </li>
          <li>
    ...
    <div class="mt-5 p-4" style="color: black;">
      <?php
      ...
      <h1 class="mt-5 fw-bol">Dashboard - <span class="fs-4 text-secondary"> <?php echo $day. " ". $dayOfMonth." ". " ". $month. " ". $year; ?> </span></h1>
    
      <div class="alert" role="alert" style="background-color: #E9D5FF;">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard Admin Perpustakaan</div>
